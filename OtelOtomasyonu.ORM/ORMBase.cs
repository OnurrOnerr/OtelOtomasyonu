...
namespace OtelOtomasyonu.ORM
{
...

    {
        private string ClassName
        {
            get
            {
                //tipi belli olmayan bir elemanın tipini gösterir (generik bir tipi belirlemeyi sağlar)
        ...
        public bool Insert(T entity)
        {
            ...
            //GetProperties T elemanı içerisindeki propertileri bir dizi olarak gönderen metodtur.
